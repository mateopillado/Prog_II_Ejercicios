...
//serviceManager.GetAllClientes();

//var lst = serviceManager.GetAllClientes();
...
{ 
    ...
    {Id = tiposDeCuenta[0].Id }
};

cliente.Cuentas.Add(cuentaNueva);
ClienteRepository clienteRepository = new ClienteRepository();



Console.WriteLine(clienteRepository.Add(cliente)); 
